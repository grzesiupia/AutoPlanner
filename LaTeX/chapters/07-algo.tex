...
z listy krotek zostaje zabrana pierwsza z brzegu krotka,
wybrana krotka zostaje przydzielona do pierwszej możliwej konkretnej godziny w konkretnym dniu (czyli do takiej jednostki godzinowej, wtórej są spełnione wprowadzone przez użytkownika założenia oraz jest wolna sala),
poprzednie czynności zostają powtarzane tak długo, aż cała lista zostanie przeiterowana.
