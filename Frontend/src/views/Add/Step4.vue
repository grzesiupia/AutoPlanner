  ...
  <div>
    ...
    <br>
        <my-component v-for="clas in classes" :key="clas.name">
          <input class="buttonm btn btn-success mr-3" type="button" v-model="clas.name" @click="editClass(clas)">
        </my-component>
    </p></b>
    <a>
    <form class=topform @submit="addClass">
      ...
      <p><input class="buttond" type="button" @click="addSubject" value="+" >
