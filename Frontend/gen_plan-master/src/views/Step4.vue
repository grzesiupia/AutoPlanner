<template>
  <div>
    ...
    <br><input class="buttonm btn btn-success mr-3" value="1A">
    <input class="buttonm btn btn-success mr-3" value="1B">
    <input class="buttonm btn btn-success mr-3" value="1C">
    </p></b>
    <a>
    <form class=topform>
